				...
				<form method="POST" action="adduser" class="regis100-form validate-form">
				 ...
				 <!-- <form method="POST" action="{{ route('register') }}">
					...
					<div class="wrap-input100 validate-input">
						<input id="role" type="text" class="input100 @error('role') is-invalid @enderror" name="role" placeholder="Role" required autocomplete="role">
	...
	<div class="limiter">
		<div class="container-regis100">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="wrap-input100 validate-input">
                    <input id="role" type="text" class="input100 @error('role') is-invalid @enderror" name="role" required autocomplete="role" autofocus>
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class='bx bxs-briefcase-alt-2'></i>
                    </span>
