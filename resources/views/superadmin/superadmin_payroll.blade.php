            ...
            <table>
                ...
                @foreach($data as $item)
                    <tr>
                        ...
                        <td>
                            <!-- <a href="superadmin_payroll1?ID=<?php echo $item->ID?>" class="btn btn-info" style="color: #75fcf3;"><span data-feather="edit"></span>Update</a> -->
                            <a href="superadmin_payroll1?ID=<?php echo $item->ID?>" class="btn btn-info" style="color: #75fcf3;"><span data-feather="edit"></span>Update</a>
                            <!-- <a href="/superadmin_payroll1/{{ $item->ID }}" class="btn btn-info" style="color: #75fcf3;"><span data-feather="edit"></span>Update</a> -->
