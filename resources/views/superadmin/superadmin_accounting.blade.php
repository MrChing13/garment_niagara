                ...
                <tbody style="text-align: center; color :white">
                    @foreach($data2 as $item2)
                        <tr>
                            ...
                            <td>
                                <a href="superadmin_updateuser?id=<?php echo $item2->id?>" class="btn btn-info" style="color: #75fcf3;"><span data-feather="edit"></span>Update</a>
                                |
                                <a href="superadmin_deleteuser?id=<?php echo $item2->id?>" class="btn btn-warning" style="color: #fce675;" onclick="return confirm('Are you sure?')">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
